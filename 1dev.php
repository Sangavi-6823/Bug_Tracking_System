  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="active"><a href="1dev.php"> View bug Information</a></li>
...
include ('db.php');
  ...
  $sqlup="Select * from report left join dev_reg on report.id=dev_reg.id";
...
?>
 ...
 <td align="center">
	 ...
	 {
	 ?>
<a href="status.php?id=<?php echo $res->id ?>-complete"><button type="button" style="color:green;cursor:pointer;" name="complete" value="complete"><b>complete<b></button></a><!--<a href="status.php?id=<?php echo $deve->up_id ?>-Reject"><button type="button" style="color:red; cursor:pointer;" name="Reject" value="Reject"><b>Reject<b></button></a>-->
	<?php
	}
	else
	{
