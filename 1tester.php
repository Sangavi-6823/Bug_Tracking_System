      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="active"><a href="1tester.php"> View bug Information</a></li>
		     <li class=""><a href="bug2.php">Bug Report</a></li>
...
include ('db.php');
  ...
  $sqlup="Select * from report left join test_reg on report.id=test_reg.id";
...
?>
 ...
 <td height="40" align="center"><?php echo $res->id; ?></td>
    ...
    <td align="center"><?php echo $res->pro_id; ?></td>
   <td align="center"><?php echo $res->des; ?></td>
	...
	<td align="center">
	 ...
	 {
	 ?>
<a href="status1.php?id=<?php echo $res->id ?>-complete"><button type="button" style="color:green;cursor:pointer;" name="complete" value="complete"><b>complete<b></button></a><a href="status1.php?id=<?php echo $res->id ?>-incomplete"><button type="button" style="color:red; cursor:pointer;" name="incomplete" value="incomplete"><b>Incomplete<b></button></a>	<?php
	}
	else
	{
	echo $res->status1;
