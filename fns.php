...
?>
 ...
 <td height="40" align="center"><?php echo $res->status5; ?></td>
    <td height="40" align="center"><?php echo $res->status6; ?></td>
	...
	<td align="center">
	 ...
	 {
	 ?>
<a href="status7.php?id=<?php echo $res->id ?>-complete"><button type="button" style="color:green;cursor:pointer;" name="complete" value="complete"><b>complete<b></button></a>	<?php
	}
	else
	{
	echo $res->status7;
